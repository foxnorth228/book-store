...
function DropdownMenu({
  ...
  return (
    <PopoverPrimitive
      ...
      className={cn(
        "bg-popover text-popover-foreground ring-foreground/5 data-entering:animate-in data-entering:fade-in-0 data-entering:zoom-in-95 data-exiting:animate-out data-exiting:fade-out-0 data-exiting:zoom-out-95 data-[placement=bottom]:slide-in-from-top-2 data-[placement=left]:slide-in-from-right-2 data-[placement=right]:slide-in-from-left-2 data-[placement=top]:slide-in-from-bottom-2 **:data-[slot$=-item]:data-focused:bg-foreground/10 dark:ring-foreground/10 z-50 w-(--trigger-width) min-w-48 origin-(--trigger-anchor-point) overflow-x-hidden overflow-y-auto rounded-2xl p-1 shadow-2xl ring-1 duration-100 outline-none data-exiting:overflow-hidden",
        className,
      )}
    >
      <MenuPrimitive
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenu
      ...
      className={cn(
        "bg-popover text-popover-foreground ring-foreground/5 w-auto min-w-36 rounded-2xl p-1 shadow-2xl ring-1 duration-100",
        className,
      )}
      placement={placement}
      crossOffset={crossOffset}
...
const DropdownMenuComponent = Object.assign(DropdownMenu, {
